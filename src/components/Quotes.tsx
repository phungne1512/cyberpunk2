    ...
    <section className="relative px-5 py-24">
      <div className="mx-auto max-w-5xl">
        <div className="mb-12 text-center">
          <div className="font-mono text-xs tracking-[0.4em] text-cyber-magenta">// TRANSMISSIONS FROM THE STREET</div>
          <h2 className="mt-3 font-display text-4xl font-black tracking-tight text-white sm:text-5xl">
            WORDS TO <span className="text-cyber-magenta text-glow-magenta">HODL</span> BY
          </h2>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {QUOTES.map((q, i) => (
            <div
              key={i}
              className="clip-cyber relative border border-cyber-magenta/20 bg-cyber-panel/50 p-7 transition-all hover:border-cyber-magenta/50"
            >
              <Quote className="mb-4 h-8 w-8 text-cyber-magenta/60" />
